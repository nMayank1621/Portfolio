...
const ProfileCardComponent = ({
  ...
  const avatarTopRef = useRef(null);
  const avatarBottomRef = useRef(null);

  useEffect(() => {
    const topEl = avatarTopRef.current;
    const bottomEl = avatarBottomRef.current;
          ...
          <div className="pc-inside">
            ...
            <div className="pc-content pc-avatar-content">
              <div className="split-image-container">
                <div className="avatar-wrapper avatar-wrapper-top" ref={avatarTopRef}>
                  <img
                    className="avatar"
                    src={avatarUrl}
                    alt={`${name || 'User'} avatar top`}
                    loading="lazy"
                    onError={e => { e.target.style.display = 'none'; }}
                  />
                </div>
                <div className="avatar-wrapper avatar-wrapper-bottom" ref={avatarBottomRef}>
                  <img
                    className="avatar"
                    src={avatarUrl}
                    alt={`${name || 'User'} avatar bottom`}
                    loading="lazy"
                    onError={e => { e.target.style.display = 'none'; }}
                  />
                </div>
